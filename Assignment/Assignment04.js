...
//Five objects, each containing the following properties: fname, lname, title, suffix, age.
var persons = [
  { fname: "Zakaria", lname: "Abden", title: "Dr.", suffix: "Jr.", age: 23 },
  { fname: "Morgan", lname: "Block", title: "Dr.", suffix: "Jr.", age: 30 },
  { fname: "Nathan", lname: "Thomas", title: "Dr.", suffix: "Sr.", age: 25 },
  { fname: "Logan", lname: "Zipp", title: "Dr.", suffix: "Jr.", age: 20 },
  { fname: "GP", lname: "Corser", title: "Dr.", suffix: "Sr.", age: 60 },
];
console.log(persons);
persons.forEach(
  (index) =>
